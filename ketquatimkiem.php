...
<?php if ($totalRows > $pageSize) { ?>
    ...
    <ul class="pagination clearfix page_margin_top_section">
        <?php
            ...
            <li>
                <a href="search/<?= $tukhoa ?>/ "> Đầu </a>
            </li>
            <li>
                <a href="search/<?= $tukhoa ?>/<?= $pagePrev ?>/"> Trước </a>
            </li>
        ...
        <?php
            ...
            <li>
                <a href="search/<?= $tukhoa ?>/<?= $pageNext ?>/"> Sau </a>
            </li>
            <li>
                <a href="search/<?= $tukhoa ?>/<?= $totalPages ?>/"> Cuối </a>
            </li>
