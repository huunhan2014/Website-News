<div class="header_top_bar">
    <form class="search" onsubmit="this.action='/news/search/'+ document.getElementsByName('tukhoa')[0].value+'/'" action="" method="POST">
    ...
    <div class="latest_news_scrolling_list_container">
        <ul>
            ...
            <li class="date">
                <abbr title="04 Apr 2014" class="timeago current">04 Apr 2019</abbr>
