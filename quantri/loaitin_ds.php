                        ...
                        <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Ngôn Ngữ</th>
                                    <th style="width: 135px;">Cập Nhật/Xóa</th>
                                </tr>
                            </thead>
                                ...
                                <?php while ($rowLT = $kq->fetch_assoc()) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="loaitin_xoa.php?idLT=<?= $rowLT['idLT']?>" class="btn bg-red waves-effect" onclick="return confirm('bạn có chắc xóa <?=$rowLT['Ten'] ?>')">Xóa</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
