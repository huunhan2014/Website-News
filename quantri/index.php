...
<body class="theme-red">
    ...
    <section class="content">
        ...
        switch ($p) {
            case "theloai_ds":
                require "theloai_ds.php";
                break;
            case "theloai_them":
                require "theloai_them.php";
                break;

            case "theloai_sua":
                require "theloai_sua.php";
                break;

                //end theloai
            case "loaitin_ds":
                require "loaitin_ds.php";
                break;

            case "loaitin_them":
                require "loaitin_them.php";
                break;

            case "loaitin_sua":
                require "loaitin_sua.php";
                break;
                //end loaitin
            case "tin_ds":
                require "tin_ds.php";
            ...
            case "tags_them":
                require "tags_them.php";
                break;

            case "tags_sua":
                require "tags_sua.php";
                break;
                //end tags

            case "users_ds":
                require "users_ds.php";
                break;
            ...
            case "ykien_ds":
                require "ykien_ds.php";
                break;

            case "ykien_sua":
                require "ykien_sua.php";
                break;
                //end ykien
