                ...
                <form class="form-horizontal" method="post" action="">
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="Ten" name="Ten" class="form-control" placeholder="Nhập tên loại tin" maxlength="20" minlength="3" required value="<?= $row['Ten'] ?>"> </div>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="Tên loại tin không dấu" id="Ten_KhongDau" name="Ten_KhongDau" value="<?= $row['Ten_KhongDau'] ?>"> </div>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                            <button type="submit" class="btn btn-primary m-t-15 waves-effect">THÊM LOẠI TIN</button> </div>
                    </div>
                </form>
            </div>
        </div>
