...
if (isset($_POST['TenTag'])) {
    ...
    $AnHien = $_POST['AnHien'];
    $lang = $_POST['lang'];
    $qt->Tags_Them($TenTag, $TenTag_KD, $ThuTu, $AnHien, $lang);
                ...
                <form class="form-horizontal" method="post" action="">
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="TenTag" name="TenTag" class="form-control" placeholder="Nhập tên tag" maxlength="20" minlength="3" required> </div>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        ...
                        <div class="col-sm-9">
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" class="form-control" placeholder="Tên Tag không dấu" id="TenTag_KhongDau" name="TenTag_KhongDau"> </div>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-offset-2 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
                            <button type="submit" class="btn btn-primary m-t-15 waves-effect">THÊM TAG</button> </div>
                    </div>
                </form>
            </div>
        </div>
