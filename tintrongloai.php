<?php
$Ten_KhongDau = isset($_GET['Ten_KhongDau']) ? $_GET['Ten_KhongDau'] : '';
...
$kq = $t->TinTrongLoai($idLT, $pageNum, $pageSize, $totalRows); //chi lay 1 trang thu $pageNum, voi $pageSize record 
